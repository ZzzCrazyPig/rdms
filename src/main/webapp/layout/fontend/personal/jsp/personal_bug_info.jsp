...
<div class="container-fluid">
	<div class="row">
		<ol class="breadcrumb">
			<li>我的地盘</li>
			<li class="active">BUG修改</li>
		</ol>
	</div>
	<div class="row">
		<h2><span class="label label-success">需要我解决的BUG</span></h2>
		<table id="todoBugTable" class="table table-bordered"></table>
	</div>
	<div class="row">
		<h2><span class="label label-success">我创建的BUG</span></h2>
		<div id="myBugTable_toolbar">
			<div class="btn-group" role="group">
  				<button id="createBugBtn" class="btn btn-primary">创建BUG</button>
			</div>
		</div>
		<table id="myBugTable" class="table table-bordered"></table>
	</div>
	...
	<div class="modal fade" id="bugTraceModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button id="saveBugTraceBtn" type="button" class="btn btn-primary" onclick="saveBugTrace('bugTraceForm')">保存</button>
				</div>
			</div>
		</div>
	</div> <!-- end of modal -->
