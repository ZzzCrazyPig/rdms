...
<%-- 		<div class="col-md-8" style="padding-left:0px;">
			<div class="panel panel-primary">
				<div class="panel-heading">可变信息</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input id="phone" name="phone" type="text"
													class="form-control" value="${sessionScope.emp.phone }" />
											</div>
										</div>
										<div class="form-group">
											<label for="email" class="col-md-3 control-label">电子邮箱</label>
											<div class="col-md-9">
												<input id="email" name="email" type="text"
													class="form-control" value="${sessionScope.emp.email }" />
											</div>
										</div>
									</form>
									<p class="text-center"><button class="btn btn-primary" onclick="updateEmpInfo('empForm')">更改信息</button></p>
								</div>
							</div>
						</div>
					</div>
...
<%-- 		<div class="col-md-4" style="padding-right:0px;">
			<div class="panel panel-success">
				<div class="panel-heading">固定信息</div>
				<div class="panel-body">
					<form class="form-horizontal">
						<div class="form-group">
							<label for="account" class="col-md-3 control-label">账号:</label>
							<div class="col-md-9">
								<input id="account" name="account" type="text" class="form-control" value="${sessionScope.emp.account}" disabled="disabled"/>
							</div>
						</div>
						<div class="form-group">
							<label for="name" class="col-md-3 control-label">姓名:</label>
							<div class="col-md-9">
								<input id="name" name="name" type="text" class="form-control" value="${sessionScope.emp.name}" disabled="disabled"/>
							</div>
						</div>
						<div class="form-group">
							<label for="dept" class="col-md-3 control-label">部门:</label>
							<div class="col-md-9">
								<input id="dept" name="dept" type="text" class="form-control" value="${sessionScope.emp.dept}" disabled="disabled"/>
							</div>
						</div>
						<div class="form-group">
							<label for="position" class="col-md-3 control-label">职位:</label>
							<div class="col-md-9">
								<input id="position" name="position" type="text" class="form-control" value="${sessionScope.emp.position}" disabled="disabled" />
							</div>
						</div>
					</form>
				</div>
