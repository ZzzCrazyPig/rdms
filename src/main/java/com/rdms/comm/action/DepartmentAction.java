...
@Scope("prototype")
public class DepartmentAction extends GeneralAction<Department, DepartmentService, DepartmentModel> {
...
//	}
	...
	@Override
	protected Department toEntity(DepartmentModel model, Department entity) {
